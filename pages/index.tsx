          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p
              ...
              dangerouslySetInnerHTML={{
                __html: textData.homePage.aboutSection.description,
              }}
            />
            ...
            <div className="flex justify-center mt-12">
              <div className="flex flex-col items-center gap-4">
                ...
                >
                  ...
                  <span>{textData.homePage.contact.instagram.username}</span>
                </a>
              </div>
            </div>
          </div>
        ...
        <section className="px-6 py-20" id="services">
          ...
          <div className="grid md:grid-cols-3 gap-10 max-w-5xl mx-auto">
            <div className="p-6 border border-brand-200 rounded-2xl shadow-sm hover:border-brand-400 transition hover:shadow-md">
              <h3 className="font-semibold text-xl mb-2 text-brand-700">
                Desain
              </h3>
              <p className="text-gray-600">
                Perencanaan arsitektur menyeluruh, mulai dari konsep, gambar
                kerja, hingga visualisasi desain yang fungsional dan estetis.
              </p>
            </div>
            <div className="p-6 border border-brand-200 rounded-2xl shadow-sm hover:border-brand-400 transition hover:shadow-md">
              <h3 className="font-semibold text-xl mb-2 text-brand-700">
              ...
              <p className="text-gray-600">
                Penataan ulang dan peningkatan bangunan existing agar lebih
                nyaman, efisien, dan sesuai dengan kebutuhan penghuni.
              </p>
            </div>
            <div className="p-6 border border-brand-200 rounded-2xl shadow-sm hover:border-brand-400 transition hover:shadow-md">
              <h3 className="font-semibold text-xl mb-2 text-brand-700">
              ...
              <p className="text-gray-600">
                Pelaksanaan pembangunan dengan pengawasan arsitek untuk
                memastikan kualitas, ketepatan desain, dan hasil akhir yang
                optimal.
              </p>
            </div>
          </div>
